  ...
  const photos = [
    {
      ...
      caption: 'Casetta Mera - Vista esterna'
    },
    {
    ...
    },
    {
      ...
      caption: 'Vista panoramica dalle Alpi'
    },
    {
      ...
      caption: 'Terrazza con vista montagne'
    },
    {
      ...
      caption: 'Piste da sci nelle vicinanze'
    },
    {
      ...
      caption: 'Sentieri per escursioni'
    },
    {
      ...
      caption: 'Percorsi mountain bike'
    }
  ];
  ...
  return (
    <section className="py-24 bg-[var(--almond)]/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl mb-4 text-[var(--eclipse)]">Galleria Fotografica</h2>
          <p className="text-lg text-[var(--forest-roast)]/70 max-w-2xl mx-auto">
            Scopri ogni angolo della nostra casetta e i paesaggi mozzafiato che la circondano
          </p>
        </motion.div>
